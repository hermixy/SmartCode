  ...
  TextEditBase(parent)
{
  ...
  connect(this,SIGNAL(textChanged()),this,SLOT(updateCPPDocumentSource()));
...
void TextEdit::setCPPDocument(CPlusPlus::Document * doc)
{
  m_doc =  doc;
}
...
CPlusPlus::Document *TextEdit::CPPDocument() const
{
  return m_doc;
}
...
void TextEdit::updateCPPDocumentSource()
{
  m_doc->setSource(textAsBytes(text()));
}
